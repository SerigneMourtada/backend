...
public class UtilisateurMapper {
    ...
    public Utilisateur fromUtilisateurDTO(UtilisateurDTO utilisateurDTO){
        ...
        utilisateur.setCentre(centreVaccMapper.fromCentreVaccinationDTO(utilisateurDTO.getCentreVaccinationDTO()));
        return utilisateur;
    }
    ...
    public UtilisateurDTO fromUtilisateur(Utilisateur utilisateur){
        ...
        utilisateurDTO.setCentreVaccinationDTO(centreVaccMapper.fromCentreVaccination(utilisateur.getCentre()));
